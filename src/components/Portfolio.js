        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                An immersive web application for comic enthusiasts to discover, purchase, and manage their digital comic collection. Built with Vue.js frontend and Laravel backend for a seamless user experience.
              </p>
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="md:w-1/2">
                  <div className="flex flex-col gap-6">
                    <div className="relative group">
                      ...
                      <div className="relative w-full h-48 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800">
                        <img
                          src={require('../Images/Screenshot 2025-03-12 121034.png')}
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative w-full h-48 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800">
                        <img
                          src={require('../Images/Screenshot 2025-03-12 121142.png')}
                ...
                <div className="md:w-1/2">
                  ...
                  <ul className="text-gray-600 dark:text-gray-300 space-y-3 mb-6">
                    ...
                    <li>• Dynamic comic browsing with filtering and sorting options</li>
                    <li>• Admin dashboard for content management</li>
                    <li>• Secure API with Laravel Sanctum authentication</li>
                  ...
                  <div className="flex space-x-6">
                    ...
                    <a
                      ...
                      href="https://github.com/mehara-rothila/comic-portal"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-primary-500 hover:text-primary-400 transition-colors duration-200 group"
                    >
                    ...
                    <a
                      ...
                      href="https://comic-portal.netlify.app"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-primary-500 hover:text-primary-400 transition-colors duration-200 group"
                    >
